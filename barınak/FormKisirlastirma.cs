...
namespace barınak
{
    public partial class FormKisirlastirma : Form
    {
        public FormKisirlastirma()
        {
            InitializeComponent();
            KisirlastirmaGetir();
            HayvanGetir();
        ...
        public void HayvanGetir()
        {
            ...
            baglanti.Open();               
            NpgsqlCommand sorgu = new NpgsqlCommand("Select hayvan_ad from hayvanlar where " +
                "kisirlastirma_durum='-'", baglanti);
        ...
        {
            NpgsqlCommand sorgu1 = new NpgsqlCommand("insert into kisirlastirma" +
                " (kisirlastirma_tutar,hayvan_id) values (@p1,@p2)", baglanti);
            ...
            NpgsqlCommand komut1 = new NpgsqlCommand("update hayvanlar set" +
                " kisirlastirma_durum='+' where hayvan_id=@p1", baglanti);
